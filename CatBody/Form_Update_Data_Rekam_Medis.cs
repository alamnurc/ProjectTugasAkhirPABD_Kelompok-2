...
namespace CatBody
{
    public partial class Form_Update_Data_Rekam_Medis : Form
    {
        public Form_Update_Data_Rekam_Medis()
        {
            InitializeComponent();
        }
        ...
        {
            con.Open();
            SqlCommand com = new SqlCommand("exec dbo.RM_update'" + tb_IDRM.Text + "','" + cb_IDK.Text + "','" + cb_IDV.Text + "','" + dtp_V1.Text + "','" + dtp_V2.Text + "'", con);
            com.ExecuteNonQuery();
            con.Close();
        ...
        private void Form_Update_Data_Rekam_Medis_Load(object sender, EventArgs e)
        {
